---
title: 'How to Get Your CDL Learners (CLP) Permit'
...
canonical: https://driving-tests.org/academy/cdl/cdl-types/cdl-permit
---
...
<CardGroup>
  <Card title="CLP" icon="user-graduate">
    A CLP, the learner's permit, allows supervised driving practice, preparing you for the CDL exam.
  </Card>

  <Card title="CDL" icon="truck-moving">
    With a CDL, the professional license, you can independently operate commercial vehicles.
  </Card>
</CardGroup>
...
<Steps>
  ...
  <Step title="Complete the Application Form">
    Accurately fill out the **CLP application form**, available at your local DMV or [online](https://driving-tests.org/beginner-drivers/get-cdl-permit-online/).
  </Step>
