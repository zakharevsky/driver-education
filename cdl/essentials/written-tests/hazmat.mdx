---
title: 'Free CDL HazMat Endorsement Practice Test Questions'
sidebarTitle: "HazMat"
icon: 'biohazard'
...
canonical: https://driving-tests.org/academy/cdl/essentials/written-tests/hazmat
---
...
<AccordionGroup>
  <Accordion title="How much does it cost to get a HazMat endorsement?">
    The fee to get [a HazMat endorsement](https://driving-tests.org/beginner-drivers/how-to-get-hazmat-endorsement/) varies by state, but it **typically ranges from $10 to $50**. In some states, the endorsement fee is included in the CDL fee. Check with your state’s DMV for pricing information.
  </Accordion>

  <Accordion title="How long is the HazMat endorsement valid?">
