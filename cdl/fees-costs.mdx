---
title: 'How Much Does a CDL Cost in 2024? The True Cost of a CDL License'
...
The cost of obtaining a [Commercial Driver's License (CDL)](/cdl-definition) varies depending on the state, the [type of CDL](/cdl/cdl-types/classification), and the training school. On average, the total costs, including training fees, [written](/cdl/essentials/written-tests/overview) and [skills](/cdl/essentials/skills-test) test fees, and licensing fees, can range **from \$1,500 to \$8,000**. CDL training programs, which are often the most significant expense, can vary in cost based on the length and type of program. Additional expenses may include [medical exams](/cdl/maintain/medical-exams), [endorsements for specific vehicle types](/cdl/cdl-types/endorsements/introduction), and study materials. Check with local DMV offices and training schools for specific costs in your area.
...
A [DOT physical examination](/cdl/maintain/dot-physical-exam) is mandatory for CDL aspirants, including new drivers. Costs vary by provider and location.
</Accordion>
...
Consider extra costs like study materials, license renewals, [background checks for specific endorsements](/cdl/essentials/tsa-background-check), and other state-specific fees.
</Accordion>
